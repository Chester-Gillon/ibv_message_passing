 ...
 *
 *             infiniband/verbs.h is NOT wrapped in an extern "C" block, since if compiled for C++ uses a template
 *             with C linkage which is not valid in the generated Ada spec.
 */
