...
package sched_h is
   ...
   --    __CPU_FREE (cpuset)
   subtype pid_t is x86_64_linux_gnu_bits_types_h.uu_pid_t;  -- /usr/include/sched.h:37

   function sched_setparam (uu_pid : x86_64_linux_gnu_bits_types_h.uu_pid_t; uu_param : access constant x86_64_linux_gnu_bits_sched_h.sched_param) return int;  -- /usr/include/sched.h:51
   pragma Import (C, sched_setparam, "sched_setparam");

   function sched_getparam (uu_pid : x86_64_linux_gnu_bits_types_h.uu_pid_t; uu_param : access x86_64_linux_gnu_bits_sched_h.sched_param) return int;  -- /usr/include/sched.h:55
   pragma Import (C, sched_getparam, "sched_getparam");

   function sched_setscheduler
     (uu_pid : x86_64_linux_gnu_bits_types_h.uu_pid_t;
      uu_policy : int;
      uu_param : access constant x86_64_linux_gnu_bits_sched_h.sched_param) return int;  -- /usr/include/sched.h:58
   pragma Import (C, sched_setscheduler, "sched_setscheduler");

   function sched_getscheduler (uu_pid : x86_64_linux_gnu_bits_types_h.uu_pid_t) return int;  -- /usr/include/sched.h:62
   ...
   function sched_rr_get_interval (uu_pid : x86_64_linux_gnu_bits_types_h.uu_pid_t; uu_t : access time_h.timespec) return int;  -- /usr/include/sched.h:74
   pragma Import (C, sched_rr_get_interval, "sched_rr_get_interval");

   function sched_setaffinity
     (uu_pid : x86_64_linux_gnu_bits_types_h.uu_pid_t;
      uu_cpusetsize : stddef_h.size_t;
      uu_cpuset : access constant x86_64_linux_gnu_bits_sched_h.cpu_set_t) return int;  -- /usr/include/sched.h:118
   pragma Import (C, sched_setaffinity, "sched_setaffinity");

   function sched_getaffinity
     (uu_pid : x86_64_linux_gnu_bits_types_h.uu_pid_t;
      uu_cpusetsize : stddef_h.size_t;
      uu_cpuset : access x86_64_linux_gnu_bits_sched_h.cpu_set_t) return int;  -- /usr/include/sched.h:122
