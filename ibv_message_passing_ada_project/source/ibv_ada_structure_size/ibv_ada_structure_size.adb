...
procedure Ibv_Ada_Structure_Size is
   ...
   begin
      ...
      print_struct_field (struct_name, "source_gid_index", path_def.source_gid_index'Size, path_def.source_gid_index'Position);
      print_struct_field (struct_name, "destination_gid_index", path_def.destination_gid_index'Size, path_def.destination_gid_index'Position);
